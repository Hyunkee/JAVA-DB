...
CREATE TABLE `graduation` (
  ...
  `graduation_project` varchar(45) NOT NULL DEFAULT '',
  `graduation_paper` varchar(45) NOT NULL DEFAULT '',
  `graduation_test` varchar(45) NOT NULL DEFAULT '',
  `graduation_certificate` varchar(45) NOT NULL DEFAULT '',
...
INSERT INTO `graduation` VALUES (1,1,'ok',50,'','','',''),(2,2,'no',60,'','','',''),(3,3,'ok',50,'','','','');
