...
<body>
	...
	<a href="<%=request.getContextPath()%>/board/modify"><button type="button" class="btn btn-outline-primary">수정하기</button></a>
	
	<a href="<%=request.getContextPath()%>/board/list"><button type="button" class="btn btn-outline-primary">삭제하기</button></a>
</body>
</html>
