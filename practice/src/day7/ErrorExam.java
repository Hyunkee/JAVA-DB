...
public class ErrorExam {
	public static void main(String[] args){
		// 에러 내용 : he local variable num may not have been initialized
		// 에러 원인 : 지역 변수를 초기화 하지 않고 사용하는 경우
		// 해결 방법 : 해당 지역변수를 초기화 한다.
		//int num;
		//System.out.println(num);  //에러 발생 코드
		

		// 에러 내용 : num2 cannot be resolved to a variable
		...
		// 에러 내용 : java.lang.ArrayIndexOutOfBoundsException: 5
